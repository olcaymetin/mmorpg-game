...
export class PlacedObjectState extends Schema { id!: string; type!: string; x!: number; y!: number; scale!: number; animSpeed!: number; mapId!: string; angle!: number; flipX!: boolean; blocked!: boolean; }
defineTypes(PlacedObjectState, { id: "string", type: "string", x: "float32", y: "float32", scale: "float32", animSpeed: "float32", mapId: "string", angle: "float32", flipX: "boolean", blocked: "boolean" });
